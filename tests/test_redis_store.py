...
def _ctx(tenant: str = "acme", session_id: str = "s-1", run_id: str = "r-1") -> RunContext:
    return RunContext(tenant=tenant, principal="user:1", run_id=run_id, trace_id="tr-1", session_id=session_id)
