...
from agentdeck.adapters.engines.openai_agents.runconfig import handoff_ends_on_user_turn_mapper, tracing_enabled
    ...
    def from_agent(
        ...
        **runner_options: Any,
        ...
        run_config = RunConfig(
            ...
            handoff_history_mapper=handoff_ends_on_user_turn_mapper if runner.handoff_ends_on_user_turn else None,
