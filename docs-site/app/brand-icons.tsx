...
export function BrandSpark({ className = '', size = 16, color = 'currentColor' }: BrandIconProps) {
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`brand-svg-spark ${className}`}
      role="img"
      aria-label="AgentDeck spark"
    >
