...
export const CodeBlockFilename = ({
  ...
  // The upstream component maps a filename to one of ~70 brand logos from `react-icons`, which is
  // 85MB installed. The site names its files in text; a caller that wants a glyph passes one.
  const Icon = icon;
