...
/**
 * The Deck, drawn as the mark itself: the ace-cut card, the A painted over it, and the spark in
 * Ace Red. All three paths are copied verbatim from `docs/brand/components/`, in the mark space
 * they are drawn for, so this is the logo rather than a card that resembles it.
 *
 * `card` alone is what the layers behind the front one carry, since only the front one is the
 * whole lockup.
 */
const CARD_PATH =
  "M 135 0 H 650 L 1000 350 V 1010 A 135 135 0 0 1 865 1145 H 135 A 135 135 0 0 1 0 1010 V 135 A 135 135 0 0 1 135 0 Z";
const A_PATH =
  "M 520.569 357.501 c 10.602 3.271 24.999 13.347 31.281 21.722 c 2.618 3.533 15.183 26.171 28.009 50.249 c 40.050 75.504 45.286 85.318 52.354 98.142 c 3.796 6.805 11.780 21.591 17.669 32.714 c 14.005 26.302 24.606 45.931 45.155 83.748 c 9.162 16.880 25.784 47.763 37.040 68.700 c 11.125 20.806 38.218 70.924 60.207 111.228 c 21.858 40.304 42.145 77.467 44.893 82.701 c 12.565 23.162 11.649 46.585 -2.356 66.998 c -5.628 8.113 -16.884 16.095 -27.093 19.105 c -9.816 3.010 -79.839 2.879 -89.786 -0.131 c -12.303 -3.664 -25.391 -14.918 -31.543 -26.956 c -1.571 -3.010 -5.890 -10.992 -9.685 -17.404 c -6.282 -10.730 -14.135 -24.732 -39.920 -70.662 c -4.843 -8.637 -14.266 -25.386 -20.941 -37.294 c -11.910 -21.330 -22.119 -39.649 -41.098 -73.672 c -5.235 -9.422 -15.183 -27.611 -21.988 -40.173 c -6.806 -12.562 -14.921 -27.480 -18.062 -33.238 c -6.937 -12.824 -11.649 -18.189 -18.716 -21.460 c -13.088 -6.281 -26.700 -4.318 -36.909 5.103 c -5.890 5.365 -8.638 10.076 -35.077 58.100 c -8.246 15.048 -21.334 38.603 -29.056 52.343 c -7.853 13.609 -19.240 34.023 -25.522 45.145 c -6.282 11.123 -26.831 47.370 -45.678 80.477 c -37.695 66.082 -41.098 70.662 -55.626 77.467 l -7.984 3.664 l -43.846 0.000 l -43.846 0.000 l -7.591 -3.533 c -24.475 -11.515 -37.564 -42.267 -29.449 -69.092 c 1.178 -4.057 21.334 -41.743 39.003 -73.280 c 6.021 -10.861 16.884 -30.620 42.145 -77.205 c 6.937 -12.562 21.465 -39.649 32.459 -60.194 c 10.994 -20.544 24.344 -45.538 29.842 -55.614 c 5.366 -10.076 11.780 -21.853 14.005 -26.171 c 2.356 -4.318 11.910 -21.984 21.203 -39.257 c 9.424 -17.273 23.952 -44.360 32.459 -60.194 c 8.507 -15.834 19.633 -36.509 24.606 -45.800 c 16.491 -30.359 28.794 -53.259 41.490 -77.074 c 14.397 -26.956 22.512 -37.032 35.470 -43.968 c 11.125 -5.889 18.062 -7.590 32.067 -7.721 c 8.638 -0.131 14.397 0.654 20.418 2.486 z";
const SPARK_PATH =
  "M 983.307 154.026 l -13.007 29.775 c -4.993 11.450 -20.837 11.450 -25.843 0.000 l -13.007 -29.775 c -11.582 -26.508 -32.405 -47.604 -58.379 -59.132 L 837.294 79.013 c -11.373 -5.045 -11.373 -21.606 0.000 -26.664 l 34.667 -15.384 C 898.614 25.135 919.804 3.268 931.190 -24.129 l 13.163 -31.736 c 4.889 -11.777 21.163 -11.777 26.052 0.000 L 983.569 -24.129 c 11.373 27.409 32.575 49.290 59.229 61.106 l 34.667 15.384 c 11.373 5.045 11.373 21.606 0.000 26.664 l -35.791 15.894 C 1015.712 106.435 994.876 127.532 983.307 154.026 Z";
...
function DeckLockup() {
  return (
    <svg className="ad-card ad-card--lockup" viewBox="0 -64.70 1085.99 1209.70" fill="none" role="img" aria-label="AgentDeck">
      <path d={CARD_PATH} />
      <path className="ad-card__counter" transform="translate(0 -30)" d={A_PATH} />
