...
&nbsp;→ [#250](https://github.com/sagi5060/agentdeck/issues/250)
...
&nbsp;→ [#251, folded into #250](https://github.com/sagi5060/agentdeck/issues/250)
...
&nbsp;→ [#247](https://github.com/sagi5060/agentdeck/issues/247)
...
&nbsp;→ [#229](https://github.com/sagi5060/agentdeck/issues/229)
...
&nbsp;→ [#177](https://github.com/sagi5060/agentdeck/issues/177)
...
&nbsp;→ [#232](https://github.com/sagi5060/agentdeck/issues/232)
...
&nbsp;→ [#212](https://github.com/sagi5060/agentdeck/issues/212)
...
&nbsp;→ [#244](https://github.com/sagi5060/agentdeck/issues/244)
...
&nbsp;→ [#178](https://github.com/sagi5060/agentdeck/issues/178)
...
| What | Issue |
|---|---|
| `agentdeck-serve --help` crashes instead of printing usage | [#245](https://github.com/sagi5060/agentdeck/issues/245) |
| `run()`'s return type makes the documented interrupt idiom fail a type checker | [#231](https://github.com/sagi5060/agentdeck/issues/231) |
| Checkpointer connection failures surface as raw driver exceptions, not `StoreError` | [#233](https://github.com/sagi5060/agentdeck/issues/233) |
| An engine failure over HTTP returns bare text rather than the documented 500 shape | [#243](https://github.com/sagi5060/agentdeck/issues/243) |
| `answer()` accepts any value with no validation, and the node owns interpreting it | [#235](https://github.com/sagi5060/agentdeck/issues/235) |
| Omitting `context` on `answer()` silently gives the re-run node `None` | [#255](https://github.com/sagi5060/agentdeck/issues/255) |
| The CLI can send signals but cannot read anything — no inbox, no run view | [#256](https://github.com/sagi5060/agentdeck/issues/256) |
| `redis` is a base dependency because the default session path imports it | [#253](https://github.com/sagi5060/agentdeck/issues/253) |
| A `DataBlock` cannot be sent *to* a model, only received from one | [#226](https://github.com/sagi5060/agentdeck/issues/226) |
| `Deck.asgi()` cannot serve an agent whose tools declare a `Context` | [#227](https://github.com/sagi5060/agentdeck/issues/227) |
