...
A context is a live Python object, never serialized. It cannot cross the HTTP surface, and the
timer sweep that resumes a durable workflow supplies none. See
