...
**Status:** Design of record for `Deck`'s composition API, cited by `agentdeck/authoring/agent.py`.

**Delivered** in v3.0.0 · **Date:** 2026-08-09 · Resolves #88, blocks phases 5–6, and supersedes the
Option A recommendation in the v3 entry-point decision where they differ.
...
booking_agent = Agent(
    ...
    mcp=["calendar", "crm"],
)  # names, resolved from the deck's MCP file
