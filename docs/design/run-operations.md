...
Decided 2026-08-14. Amends the v3 entry-point decision: ruling 2 and its no-daemon note.
...
This amends the no-daemon note in the v3 entry-point decision, which dropped `tick` on the grounds
